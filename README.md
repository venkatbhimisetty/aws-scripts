...
Pre-Requisites
DB Subnet - The RDS instances requires the db subnet group to span across (atleast two) availability zones
DB Security Group - Security group all allows other EC2 instances to connect with this RDS instance
...
[3] Cloning RDS Instances for Testing
